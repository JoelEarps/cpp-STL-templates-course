...
//merge to sorted sequences into one
int main() {
    ...
    disp_v(v2);
    cout << endl;
    //beginning and end of first and element, second element and new merged element
    // can also add your own comparison function
