...
//conatiner optimised for rapid insert and delete opeerations
...
int main() {
    ...
    //push back element on the back
    l1.push_back(47);
    printl(l1);
    
    // need an iterator to insert and erase
    message("insert:");
    //declare itertor (can use auto) - iterator, template type and inirlaise it at the beginning of the list

    list<int>::iterator it1 = l1.begin();
    //look through list and then add value before 5
    ...
    //no random access - iteratre thoough list and 
    ...
    // remove element value 8 - same for iterator
    l1.remove(8);
    message("remove 8");
    printl(l1);
    
    //iterature between two values
    //none inclusive range
...
//situations don't need random access - fast and lean but expense of functionality