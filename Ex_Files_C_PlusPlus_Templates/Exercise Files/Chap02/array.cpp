...
#include <string>
using namespace std;
//size cannot change during the life of the array
//fast an effiient - stored coniguos memory 
//not as flexible as the vector
...
int main() {
    ...
    // check the size - alweays size array is constructed with
    message("size of a1", (int) a1.size());
    message("size of a2", (int) a2.size());
    
    // access elements - sibscript or at memberfunction
