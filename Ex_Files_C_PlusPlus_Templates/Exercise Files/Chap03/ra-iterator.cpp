...
//random access is most complete iterator
//can access any element at any point in a container
//has all the functionality of a c++ pointer
int main() {
    ...
    cout << endl;
    //so forward iteration, backwards iteration and range based loops all work but we can also 
    //access elements directly
    it1 = v1.begin() + 5;
    message("element begin + 5", *it1);
    message("element [5]", v1[5]);

    //end points passed the end of the container
    it1 = v1.end() - 3;
